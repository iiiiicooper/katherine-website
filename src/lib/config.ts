...
const defaultProjects: ProjectItem[] = [
  {
    ...
    timeline: "2023",
    assets: [
      { id: "p1-a1", src: "/p1-1.png", alt: "uSpeedo.ai UI 1", caption: "uSpeedo.ai is an all-in one AI Marketing platform. Using AI to quickly generate high-quality marketing images for different social media platforms." },
      { id: "p1-a2", src: "/p1-2.png", alt: "uSpeedo.ai UI 2", caption: "It analyzes trending events and popular BGMs, then generates posts that fit today's trends." },
